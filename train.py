...
from models.ERGCN import ERGCN
...
class Instructor:
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader,test_data_loader,max_test_acc,max_test_f1):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            for i_batch, batch in enumerate(train_data_loader):
                ...
                if global_step % self.opt.log_step == 0:
                    ...
                    test_acc, test_f1, test_precision, test_recall = self._evaluate_acc_f1(test_data_loader)
                    logger.info(
                        '> max_val_f1: {:.4f}, max_val_acc: {:.4f},  max_val_precision: {:.4f}, max_test_recall: {:.4f}'.format(
                            max_val_f1, max_val_acc, max_val_precision, max_val_recall))
                    logger.info(
                        '> max_test_f1: {:.4f}, max_test_acc: {:.4f},  max_test_precision: {:.4f}, max_test_recall: {:.4f}'.format(
                            max_test_f1, max_test_acc, max_test_precision, max_test_recall))
                    logger.info('> val_acc: {:.4f}, val_f1: {:.4f},val_precision: {:.4f},val_recall: {:.4f}'.format(val_acc, val_f1,val_precision,val_recall))
                    logger.info('> test_acc: {:.4f}, test_f1: {:.4f},test_precision: {:.4f},test_recall : {:.4f}'.format(test_acc,test_f1,test_precision,test_recall))
        ...
        val_acc, val_f1,val_precision,val_recall = self._evaluate_acc_f1(val_data_loader,macro = True)
        test_acc_, test_f1_,test_precision_,test_recall_ = self._evaluate_acc_f1(test_data_loader)
        return (val_acc, val_f1,val_precision,val_recall) , (test_acc_, test_f1_,test_precision_,test_recall_)
...
def main():
    ...
    parser.add_argument('--model_name', default='ERGCN', type=str)
    ...
    parser.add_argument('--path', default="/data/user/lls/ACL22-sarcasm-code/GCN", type=str)
    ...
    input_colses = {
        'ERGCN':['bert_indices', 'graph', 'box_vit', 'caption_indices'],
    }
    initializers = {
